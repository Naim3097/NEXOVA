...
import { getCategoryCounts } from '@/lib/elements-data';
...
const ANIMATION_CATEGORIES = getCategoryCounts();
          ...
          <RevealOnScroll>
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500">
                Every card below is a real, working animation — all{' '}
                <span className="font-semibold text-gray-700">100</span>{' '}
                elements from our library.
              </p>
            </div>
          </RevealOnScroll>
