...
interface ProductRelatedWidgetProps {
  products?: Product[];
  columns?: number;
  limit?: number;
}

export default function ProductRelatedWidget({ 
  products = [
    { id: 1, name: "Related Item 1", price: "$79.00", rating: 5 },
    { id: 2, name: "Related Item 2", price: "$89.00", rating: 4 },
    { id: 3, name: "Related Item 3", price: "$99.00", rating: 5 },
    { id: 4, name: "Related Item 4", price: "$109.00", rating: 4 },
  ],
  columns = 4, 
  limit = 4 
}: ProductRelatedWidgetProps) {
