      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center max-w-4xl mx-auto mb-2">
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight text-black mb-4 leading-tight">
            Build <span className="text-[#4FD1C5]">•</span> Edit{' '}
            <span className="text-[#4FD1C5]">•</span> Sell
            <br />
            All in one flow
          </h1>

          <p className="text-lg text-gray-500 mb-6 max-w-2xl mx-auto leading-relaxed">
            Stop stitching tools together. The only professional builder with
            native payments and live inventory baked directly into the design
            process.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/marketplace">
              <Button
                size="lg"
                className="bg-black hover:bg-gray-800 text-white rounded-full px-8 h-12 text-base font-medium"
              >
                View Templates
              </Button>
            </Link>
